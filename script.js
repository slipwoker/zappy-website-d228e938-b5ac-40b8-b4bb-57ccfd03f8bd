            ...
            if (!hasErrors) {
                ...
                fetch(action, fetchOptions)
                    ...
                    .then(function(data) {
                        ...
                        successMessage.textContent = contactForm.getAttribute('data-success-message') || 'Thank you! Your message has been sent.';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'd228e938-b5ac-40b8-b4bb-57ccfd03f8bd',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'd228e938-b5ac-40b8-b4bb-57ccfd03f8bd';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'd228e938-b5ac-40b8-b4bb-57ccfd03f8bd';
